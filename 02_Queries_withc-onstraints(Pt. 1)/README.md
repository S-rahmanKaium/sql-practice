...
SELECT year,title --> These are columns
FROM movies --> Table name
WHERE where 
    year not between 2000 and 2010 ; --> Condition checking

```
> This code will filter the database and only give output of **year** and **title** columns from **movies** table between 2000 and 2010.  
